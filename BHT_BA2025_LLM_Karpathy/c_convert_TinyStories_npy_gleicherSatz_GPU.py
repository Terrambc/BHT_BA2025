...
Für GPT2-Small angepasst auf GPU Nutzung
"""
...
max_length = 1024         # Max. Länge pro Eintrag #vorher 1024
train_token_limit = 6449511   # Exakte Anzahl Trainings-Tokens wie bei Raschka

tokenizer = tiktoken.get_encoding("gpt2")
text_key = "story"        # ggf. anpassen

B = 8        # Batchgröße (wie im Karpathy-Training) # vorher 8
T = 1024     # Kontextlänge (wie im Karpathy-Training) # vorher 1024
...
def write_npy_shards(tokens, prefix, shard_size, outdir, min_size=8192):
