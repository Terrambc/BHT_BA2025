...
Nun für GPU Training vorbereitet. 
...
def main():
    ...
    total_batch_size = 8192 ### 2048 Zusatz: letzter Stand 8192 || läuft gerade noch mit meinem System 16384
    B = 8                   ### Zusatz: Reduziert von 8 auf 4 um die Trainingszeit zu reduzieren für die Analyse || Original:  Micro Batch Size - orginal eingestellt 64
    ...
    if master_process:
        wandb.init(
            project="Analyse_auf_GPU",
            name = "karpathy_gpu_123",
            config={
                "Dataset": "TinyStories",
                "batch_size": B,
